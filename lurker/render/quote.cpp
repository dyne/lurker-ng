...
find_quote_end_l2:
	...
	if (*c < 91) 
		if (*c < 62) 
			if (*c < 59) 
				if (*c < 58) goto find_quote_end_l1;
				else goto find_quote_end_l3;
			else goto find_quote_end_l1;
		else 
			if (*c < 65) 
				if (*c < 63) goto find_quote_end_l3;
				else goto find_quote_end_l1;
		...
		if (*c < 124) 
			...
			if (*c < 125) goto find_quote_end_l3;
			else goto find_quote_end_l1;
find_quote_end_l3:
	++c;
	if (c == end) return out;
	if (*c < 62) 
		if (*c < 58) 
			...
			if (*c < 59) goto find_quote_end_l3;
			else goto find_quote_end_l1;
	else 
		if (*c < 124) 
			if (*c < 63) goto find_quote_end_l3;
	...
	*--scratch = 0;
	...
	if (*c < 62) 
		if (*c < 58) 
			...
			if (*c < 59) goto find_quote_starts_l2;
			else goto find_quote_starts_l0;
	else 
		if (*c < 124) 
	...
	*--scratch = 0;
	...
	if (*c < 63) 
		if (*c < 33) 
			...
			if (*c < 59) 
				if (*c < 58) goto find_quote_starts_l0;
		...
		if (*c < 123) 
			if (*c < 91) 
				...
				if (*c < 97) goto find_quote_starts_l0;
				else goto find_quote_starts_l4;
		else 
			if (*c < 125) 
