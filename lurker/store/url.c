 ...
 * cvs id tag: $Id: url.c,v 1.5 2002-08-14 10:21:09 terpstra Exp $
 *
 * Regular expression: (((([a-zA-Z]+)://((([A-Za-z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]|[a-zA-Z0-9])\.)*([A-Za-z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]|[a-zA-Z0-9])))|(www\.((([A-Za-z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]|[a-zA-Z0-9])\.)*([A-Za-z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]|[a-zA-Z0-9]))\.([A-Za-z0-9][a-zA-Z0-9\-]*[a-zA-Z0-9]|[a-zA-Z0-9])))(:([0-9]+))?(((/([A-Za-z%~0-9:.,_\-]*[A-Za-z0-9]|#|\.\.))+))?(\#([A-Za-z%~0-9:.,_\-]*[A-Za-z0-9]|#|\.\.))?(\?([A-Za-z%~0-9.,_=/:;+\&\-]+))?)
 */
